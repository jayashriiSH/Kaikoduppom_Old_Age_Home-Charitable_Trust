        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {services.map((service, i) => (
            <motion.div
              ...
              className="group relative bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg border border-border hover:border-gold/30 transition-all duration-300 cursor-default overflow-hidden flex flex-col h-full min-h-[165px]"
            >
              {/* Top accent line */}
